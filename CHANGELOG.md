...
- AI content tools (remaining): portfolio image alt text (needs a vision model) — the journal drafter, service/portfolio copy polisher, and page meta-description drafter (`/admin/content`) are shipped
- AI public-facing (later, higher guardrails): a content-grounded FAQ/concierge widget — the last and largest AI piece (natural-language admin search is shipped)
