...
- AI admin intelligence reusing `ai.ts`: inquiry triage, questionnaire→prep brief, client-facing plan-summary drafting, per-project next-action nudges
- AI content tools: journal post drafts, service/portfolio copy, portfolio image alt text + page meta descriptions
- AI public-facing (later, higher guardrails): a content-grounded FAQ/concierge widget and natural-language admin search
